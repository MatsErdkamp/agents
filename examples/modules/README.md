...
A focused example of the new `@cloudflare/think/modules` surface.
...
- [`assistant`](../assistant) for a full conversational `Think` host
- [`structured-input`](../structured-input) for a smaller UI-oriented AI SDK example
