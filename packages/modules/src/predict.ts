...
> extends Module<I, O> {
  ...
  protected override async forward(
    ...
    const effectiveSignature: Signature<I, O> = {
      ...this.signature,
      instructions: context.resolved.instructions,
      inputFieldDescriptions: context.resolved.inputFieldDescriptions,
      outputFieldDescriptions: context.resolved.outputFieldDescriptions
    };
